...
r5 = st.selectbox("5. ¿Puedes practicar en casa sin molestar?",
                  ["Sí", "No"])
if r5 == "No":
    puntuar(["Trompeta", "Trombón", "Tuba/Bombardino", "Percusión clásica"], -2)

r6 = st.selectbox("6. ¿Qué presupuesto inicial podrías dedicar?",
                  ["<200 €", "200–500 €", ">500 €"])
if r6 == "<200 €":
